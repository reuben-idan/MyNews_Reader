...
// Helper function to generate article URLs
function generateArticleUrl(article: Article, index: number): string {
  // For related articles, use numeric IDs for simplicity
          ...
          <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {relatedArticles.map((relatedArticle, index) => (
                <Link
                  key={index}
                  href={generateArticleUrl(relatedArticle, index)}
