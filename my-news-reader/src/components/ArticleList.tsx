...
const mockArticles = [
  ...
  {
    id: '3',
    title: 'Climate Change Summit Produces Historic Agreement',
    description: 'World leaders unite on ambitious climate action plan with concrete targets.',
    url: 'https://example.com/article3',
    urlToImage: 'https://images.unsplash.com/photo-1569163139394-de4e4f43e4e4?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-18T10:45:00Z').toISOString(),
  ...
  },
  {
    ...
    description: 'New battery technology promises 1000-mile range and 5-minute charging.',
    url: 'https://example.com/article4',
    urlToImage: 'https://images.unsplash.com/photo-1593941707874-ef25b8b4a92b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-17T16:20:00Z').toISOString(),
    source: { name: 'Auto Tech' },
    category: 'technology',
  },
  {
    id: '5',
    title: 'Mental Health Awareness Month Highlights Workplace Support',
    description: 'Companies implement comprehensive mental health programs for employees.',
    url: 'https://example.com/article5',
    urlToImage: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-16T12:00:00Z').toISOString(),
  ...
  },
  {
    ...
    description: 'NASA telescope identifies Earth-like planet in nearby star system.',
    url: 'https://example.com/article6',
    urlToImage: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-15T09:30:00Z').toISOString(),
    source: { name: 'Space News' },
    category: 'science',
  },
  {
    id: '7',
    title: 'Streaming Platform Launches Interactive Entertainment',
    description: 'New technology allows viewers to influence story outcomes in real-time.',
    url: 'https://example.com/article7',
    urlToImage: 'https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-14T18:45:00Z').toISOString(),
  ...
  },
  {
    ...
    description: 'Decorated athlete reflects on journey from humble beginnings to global stardom.',
    url: 'https://example.com/article8',
    urlToImage: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
    publishedAt: new Date('2025-09-13T14:10:00Z').toISOString(),
